export const portfolioData = {
  personalInfo: {
    ...
    imgae: "/profile.jpg",
    title: ["Full-Stack Developer", "MERN Architect", "API Developer", "UI Developer", "UX Developer", "React Developer"],
    location: "Dhaka, Bangladesh",
    tagline: "Building scalable web engines, high-performance UI systems, and interactive digital experiences.",
    bio: "Full-stack engineer specializing in Next.js, TypeScript, and the MERN stack. I build robust digital products spanning authentication architectures, complex dashboard systems, and animation-heavy frontends.",
    socials: {
